...
响应曲线测量的注意事项}{CO2 响应曲线测量的注意事项}}\label{co2-}

\subsection{分段性}

尽管上文对其分段性做了数学上的解释，相比来讲，不是那么通俗易懂，他的分段性是由下面的因素决定的：
...
## [7] minpack.lm_1.2-1   plantecophys_1.3-2
## 
...
## [17] gtable_0.2.0     cellranger_1.1.0 evaluate_0.11    labeling_0.3    
## [21] geepack_1.2-1    knitr_1.20       highr_0.7        Rcpp_0.12.18    
