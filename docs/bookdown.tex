...
同时 \citet{stinziano2018} 还给出了专门的 RACiR 数据分析软件包
\href{https://github.com/jstinzi/racir}{racir
package}，以下内容是我之前写的内容，部分代码的实现和上述软件包相似，仅供参考。

后续会更新 \texttt{racir} 相关的分析方法。
...
## [25] stringr_1.3.1    dplyr_0.7.7      knitr_1.20       tidyselect_0.2.4
