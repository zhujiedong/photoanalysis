...
\begin{verbatim}
##  [1] 1.218484 1.308225 1.693291 1.296981 1.416508 1.503341 1.374633 1.219730
##  [9] 1.551951 1.289405 1.576859 1.717097 1.387691 1.297840 1.337444 1.349185
## [17] 1.933665 1.368240 1.794020 1.470330 1.598262 1.278160 1.477005 1.319067
## [25] 1.883461 1.627449 1.300840 1.369836 1.784851 1.608252 1.585493 1.902004
\end{verbatim}
...
\begin{verbatim}
##  [1] 1.522955 1.222351 1.528873 1.841593 1.319274 1.274965 1.705751 1.787976
##  [9] 1.986696 1.262457 1.295263 1.897147 1.389497 1.835727 1.681567 1.575300
## [17] 1.403580 1.892993 1.931185 1.398952 1.241158 1.655940 1.204569 1.224229
## [25] 1.368149 1.371307 1.381866 1.737346
\end{verbatim}
...
\begin{verbatim}
##  [1] 0.4930028 0.4985469 0.4843813 0.4988438 0.4900925 0.4936470 0.5438019
##  [8] 0.4893180 0.4919430 0.5076105 0.4982150 0.5057108
\end{verbatim}
...
\CommentTok{\# 补偿点计算}
\NormalTok{Ic \textless{}{-}}\StringTok{ }\NormalTok{(}
  \OperatorTok{{-}}\NormalTok{(fitlrc\_mrec}\OperatorTok{$}\NormalTok{coef[}\DecValTok{3}\NormalTok{, }\DecValTok{1}\NormalTok{] }\OperatorTok{*}\StringTok{ }\NormalTok{fitlrc\_mrec}\OperatorTok{$}\NormalTok{coef[}\DecValTok{4}\NormalTok{, }\DecValTok{1}\NormalTok{] }\OperatorTok{{-}}\StringTok{ }
\StringTok{  }\NormalTok{fitlrc\_mrec}\OperatorTok{$}\NormalTok{coef[}\DecValTok{1}\NormalTok{, }\DecValTok{1}\NormalTok{]) }\OperatorTok{{-}}\StringTok{ }\KeywordTok{sqrt}\NormalTok{((fitlrc\_mrec}\OperatorTok{$}\NormalTok{coef[}\DecValTok{3}\NormalTok{, }\DecValTok{1}\NormalTok{] }\OperatorTok{*}\StringTok{ }
\StringTok{  }\NormalTok{fitlrc\_mrec}\OperatorTok{$}\NormalTok{coef[}\DecValTok{4}\NormalTok{, }\DecValTok{1}\NormalTok{] }\OperatorTok{{-}}\StringTok{ }\NormalTok{fitlrc\_mrec}\OperatorTok{$}\NormalTok{coef[}\DecValTok{1}\NormalTok{, }\DecValTok{1}\NormalTok{])}\OperatorTok{\^{}}\DecValTok{2}\OperatorTok{{-}}\StringTok{ }
\StringTok{  }\NormalTok{(}\DecValTok{4} \OperatorTok{*}\StringTok{ }\NormalTok{fitlrc\_mrec}\OperatorTok{$}\NormalTok{coef[}\DecValTok{1}\NormalTok{, }\DecValTok{1}\NormalTok{] }\OperatorTok{*}\StringTok{ }\NormalTok{fitlrc\_mrec}\OperatorTok{$}\NormalTok{coef[}\DecValTok{2}\NormalTok{, }\DecValTok{1}\NormalTok{] }\OperatorTok{*}\StringTok{ }
\StringTok{  }\NormalTok{fitlrc\_mrec}\OperatorTok{$}\NormalTok{coef[}\DecValTok{4}\NormalTok{, }\DecValTok{1}\NormalTok{])))}\OperatorTok{/}
\StringTok{  }\NormalTok{(}\DecValTok{2}\OperatorTok{*}\NormalTok{fitlrc\_mrec}\OperatorTok{$}\NormalTok{coef[}\DecValTok{1}\NormalTok{,}\DecValTok{1}\NormalTok{]}\OperatorTok{*}\NormalTok{fitlrc\_mrec}\OperatorTok{$}\NormalTok{coef[}\DecValTok{2}\NormalTok{,}\DecValTok{1}\NormalTok{])}
