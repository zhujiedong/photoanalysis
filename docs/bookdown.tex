...
\begin{verbatim}
##  [1] 1.579073 1.501740 1.542176 1.528177 1.364331 1.439344 1.673660 1.201694
##  [9] 1.819070 1.244356 1.393616 1.290223 1.884076 1.556310 1.402608 1.501840
## [17] 1.328353 1.268127 1.422529 1.752215 1.719004 1.378980 1.402086 1.535250
## [25] 1.363521 1.247785 1.488431 1.225667 1.294746 1.770865 1.605067 1.462061
\end{verbatim}
...
\begin{verbatim}
##  [1] 1.534630 1.908637 1.385042 1.883238 1.842859 1.203654 1.259905 1.213358
##  [9] 1.231914 1.770978 1.604164 1.260361 1.276029 1.593392 1.980809 1.394126
## [17] 1.205658 1.329265 1.214801 1.555646 1.368850 1.938286 1.591491 1.647189
## [25] 1.820577 1.315144 1.968053 1.780774
\end{verbatim}
...
\begin{verbatim}
##  [1] 0.5321714 0.5137896 0.5147278 0.4834552 0.5046826 0.4962697 0.4995047
##  [8] 0.5362518 0.4924592 0.4901329 0.4976742 0.5362240
\end{verbatim}
...
\toprule
parameters & data\_file1 & data\_file2 & data\_file3 & data\_file4 & NA\\
\midrule
...
\subsection{图像查看 函数}\label{plotfluor}}

\sout{\mbox{\texttt{jip\_plot}} 和 \mbox{\texttt{jip\_dcplot}} 基于 \mbox{\texttt{ggplot2}}，用于快速预览所有测量结果的 ojip 曲线。函数仅有一个参数，即保存数据文件夹的路径，使用如下：}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{plot}\NormalTok{(dcjipdata)}
\end{Highlighting}
\end{Shaded}
...
实际上就是使用了 base R 的 \texttt{plot} 函数，那么一些定制化，如修改文字、大小等功能可以很方便的实现，具体参考 \texttt{?plot} 即可，默认使用了一部分定制化的参数，方便数据的快速查看。注意，目前使用同时查看的测量曲线，建议不超过 8 条，否则颜色会有重复，当然，太多了可能也看不清楚了。

如果还是喜欢默认的 \texttt{ggplot2} 风格（我不建议用了）那么使用下面的方式来使用\texttt{jip\_plot} 和 \texttt{jip\_dcplot}。

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{jiptest}\SpecialCharTok{:::}\FunctionTok{jip\_plot}\NormalTok{(}\StringTok{"./data/ojip"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{jiptest}\SpecialCharTok{:::}\FunctionTok{jip\_dcplot}\NormalTok{(}\StringTok{"./data/ojip"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
