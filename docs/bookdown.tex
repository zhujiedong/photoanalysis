...
\caption{\label{tab:unnamed-chunk-35}jiptest 批量导入数据后的样式}
\centering
\begin{tabular}{rrl}
\toprule
SECS & FLUOR & SOURCE\\
...
\caption{\label{tab:unnamed-chunk-36}jiptest DC 数据批量导入数据后的样式}
\centering
\begin{tabular}{rrl}
\toprule
SECS & FLUOR & SOURCE\\
...
## [19] lazyeval_0.2.1    curl_3.2          readxl_1.2.0     
...
## [37] tidyselect_0.2.5  tibble_2.0.0      bookdown_0.9     
...
## [55] pkgload_1.0.2     yaml_2.2.0        colorspace_1.3-2 
