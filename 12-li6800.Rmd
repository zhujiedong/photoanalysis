...
同时 @stinziano2018 还给出了专门的 RACiR 数据分析软件包 [racir package](https://github.com/jstinzi/racir)，以下内容是我之前写的内容，部分代码的实现和上述软件包相似，仅供参考。

后续会更新 `racir` 相关的分析方法。


## RACiR\texttrademark 分析的实现 {#racir68_exam}
