...
\begin{verbatim}
##  [1] 1.886386 1.353761 1.901868 1.564939 1.236319 1.854324 1.246205 1.723432
##  [9] 1.846173 1.588116 1.806057 1.747382 1.970104 1.873560 1.457601 1.385952
## [17] 1.322566 1.393218 1.694339 1.452416 1.618537 1.418005 1.782820 1.763388
## [25] 1.375576 1.205890 1.479801 1.220088 1.568095 1.434426 1.656792 1.533655
\end{verbatim}
...
\begin{verbatim}
##  [1] 0.4981191 0.4983425 0.5072835 0.4976840 0.4799287 0.5297464 0.4705903
##  [8] 0.5532171 0.4921511 0.4987067 0.4562026 0.5144596
\end{verbatim}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{add\_remark }\OtherTok{\textless{}{-}} \ControlFlowTok{function}\NormalTok{(path)\{}
\NormalTok{  df }\OtherTok{\textless{}{-}} \FunctionTok{read.csv}\NormalTok{(path)}
\NormalTok{  df}\SpecialCharTok{$}\NormalTok{remarks }\OtherTok{\textless{}{-}} \FunctionTok{gsub}\NormalTok{(}\StringTok{".csv"}\NormalTok{, }\StringTok{""}\NormalTok{, }\FunctionTok{basename}\NormalTok{(path))}
  \FunctionTok{return}\NormalTok{(df)}
\NormalTok{\}}

\NormalTok{list\_csv }\OtherTok{\textless{}{-}} \FunctionTok{lapply}\NormalTok{(files\_csv, add\_remark)}

\NormalTok{df\_remark }\OtherTok{\textless{}{-}} \FunctionTok{do.call}\NormalTok{(rbind, list\_csv)}

\NormalTok{n }\OtherTok{\textless{}{-}} \FunctionTok{ncol}\NormalTok{(df\_remark)}
\FunctionTok{head}\NormalTok{(df\_remark[,(n}\DecValTok{{-}3}\NormalTok{)}\SpecialCharTok{:}\NormalTok{n])}
\end{Highlighting}
\end{Shaded}
...
\caption{\label{tab:unnamed-chunk-62}jiptest 批量导入数据后的样式}
\centering
...
\caption{\label{tab:unnamed-chunk-63}jiptest DC 数据批量导入数据后的样式}
\centering
\begin{tabular}[t]{rrrl}
\toprule
SECS & FLUOR & NORM\_FLUOR & SOURCE\\
