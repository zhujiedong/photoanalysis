...
\begin{verbatim}
##  [1] 1.327305 1.205767 1.594091 1.375014 1.248968 1.263748 1.418427 1.535349
##  [9] 1.777565 1.585952 1.429785 1.451724 1.624514 1.301591 1.471991 1.634323
## [17] 1.889532 1.672004 1.316173 1.700095 1.238952 1.712013 1.644893 1.346821
## [25] 1.638892 1.402133 1.795456 1.395634 1.271307 1.634023 1.231247 1.718765
\end{verbatim}
...
\begin{verbatim}
##  [1] 1.479572 1.804621 1.317953 1.353811 1.412068 1.495731 1.841596 1.353700
##  [9] 1.329178 1.440082 1.953482 1.222457 1.303184 1.254123 1.401942 1.490427
## [17] 1.435836 1.344377 1.347314 1.770725 1.431316 1.717431 1.620489 1.286744
## [25] 1.880263 1.803743 1.325951 1.338791
\end{verbatim}
...
\begin{verbatim}
##  [1] 0.5189815 0.4848236 0.5119757 0.5049938 0.5017920 0.5129830 0.4965640
##  [8] 0.4831829 0.5003264 0.4941518 0.5359605 0.5226851
\end{verbatim}
...
/RapidACi} 的方法，做了一些修改，并抛弃了 \texttt{tidyverse} 的方式，以减少依赖，以及可能的软件包升级导致的无法运行。主要的修改：
...
\KeywordTok{library}\NormalTok{(racir)}
\KeywordTok{library}\NormalTok{(plantecophys)}
\NormalTok{empty <-}\StringTok{ }\KeywordTok{xls_read}\NormalTok{(}\StringTok{"data/Empty.xlsx"}\NormalTok{, }\DataTypeTok{S =}\FloatTok{10.947}\NormalTok{)}
\NormalTok{leaf <-}\StringTok{ }\KeywordTok{xls_read}\NormalTok{(}\StringTok{"data/Fast.xlsx"}\NormalTok{, }\DataTypeTok{S =}\FloatTok{10.947}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
##  [7] yaml_2.2.1           ggrepel_0.8.2        pillar_1.4.4        
## [10] backports_1.1.6      lattice_0.20-41      glue_1.4.1          
...
## [31] ggpubr_0.2.5         ellipsis_0.3.1       withr_2.2.0         
...
## [52] rlang_0.4.6          grid_4.0.0           rstudioapi_0.11     
